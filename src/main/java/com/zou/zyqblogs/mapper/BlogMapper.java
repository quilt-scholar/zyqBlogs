...
@Repository
public interface BlogMapper extends GeneralMapper {
    //后端控制台统计报表需求
    //查询博客访问量top10
    ...
    //根据博文的标题查询
    List<Map<String,Object>> queryBlogByTitle(String blog_title);

    //修改博文信息
    int updBlog(@Param("maps") Map<String,Object> map);
